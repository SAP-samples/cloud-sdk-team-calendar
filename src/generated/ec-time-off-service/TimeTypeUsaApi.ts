...
export class TimeTypeUsaApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
      TimeTypeUsa<
        DeSerializersT
      >, 
  ...
  requestBuilder(): TimeTypeUsaRequestBuilder<
    DeSerializersT
  > {
  ...
  private _schema?: {
    TIME_TYPE_EXTERNAL_CODE: OrderableEdmTypeField<TimeTypeUsa<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
CREATED_BY: OrderableEdmTypeField<TimeTypeUsa<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CREATED_DATE_TIME: OrderableEdmTypeField<TimeTypeUsa<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
EXTERNAL_CODE: OrderableEdmTypeField<TimeTypeUsa<DeSerializers>, DeSerializersT, 'Edm.Int64', false, true>,
LAST_MODIFIED_BY: OrderableEdmTypeField<TimeTypeUsa<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
LAST_MODIFIED_DATE_TIME: OrderableEdmTypeField<TimeTypeUsa<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
MDF_SYSTEM_RECORD_STATUS: OrderableEdmTypeField<TimeTypeUsa<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SICKNESS_VARIANT: OrderableEdmTypeField<TimeTypeUsa<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
