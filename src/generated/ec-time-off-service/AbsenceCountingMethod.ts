 ...
 */
export class AbsenceCountingMethod<T extends DeSerializers = DefaultDeSerializers> extends Entity implements AbsenceCountingMethodType<T> {
  /**
...
export interface AbsenceCountingMethodType<T extends DeSerializers = DefaultDeSerializers> {
  base?: DeserializedType<T, 'Edm.String'> | null;
  considerHolidays?: DeserializedType<T, 'Edm.Boolean'> | null;
  country?: DeserializedType<T, 'Edm.String'> | null;
  createdBy?: DeserializedType<T, 'Edm.String'> | null;
