 ...
 */
export class WorkScheduleDayModelSegment<T extends DeSerializers = DefaultDeSerializers> extends Entity implements WorkScheduleDayModelSegmentType<T> {
  /**
...
export interface WorkScheduleDayModelSegmentType<T extends DeSerializers = DefaultDeSerializers> {
  workScheduleDayModelExternalCode: DeserializedType<T, 'Edm.String'>;
  category?: DeserializedType<T, 'Edm.String'> | null;
  createdBy?: DeserializedType<T, 'Edm.String'> | null;
  createdDate?: DeserializedType<T, 'Edm.DateTime'> | null;
