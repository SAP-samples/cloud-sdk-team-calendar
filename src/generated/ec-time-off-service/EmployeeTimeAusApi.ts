...
export class EmployeeTimeAusApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
      EmployeeTimeAus<
        DeSerializersT
      >, 
  ...
  requestBuilder(): EmployeeTimeAusRequestBuilder<
    DeSerializersT
  > {
  ...
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(EmployeeTimeAus, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    EMPLOYEE_TIME_EXTERNAL_CODE: OrderableEdmTypeField<EmployeeTimeAus<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
CREATED_BY: OrderableEdmTypeField<EmployeeTimeAus<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CREATED_DATE_TIME: OrderableEdmTypeField<EmployeeTimeAus<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
EXTERNAL_CODE: OrderableEdmTypeField<EmployeeTimeAus<DeSerializers>, DeSerializersT, 'Edm.Int64', false, true>,
LAST_MODIFIED_BY: OrderableEdmTypeField<EmployeeTimeAus<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
LAST_MODIFIED_DATE_TIME: OrderableEdmTypeField<EmployeeTimeAus<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
MDF_SYSTEM_RECORD_STATUS: OrderableEdmTypeField<EmployeeTimeAus<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
REQUEST_ADVANCE_LEAVE_PAYMENT: OrderableEdmTypeField<EmployeeTimeAus<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
SPLIT_PAYMENT_ACROSS_FINANCIAL_YEAR: OrderableEdmTypeField<EmployeeTimeAus<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
