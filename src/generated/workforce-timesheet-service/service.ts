...
import { batch, changeset } from './BatchRequest';
  ...
  export function workforceTimesheetService<BinaryT = string,
BooleanT = boolean,
ByteT = number,
DecimalT = BigNumber,
DoubleT = number,
...
TimeT>> = defaultDeSerializers as any
  ):WorkforceTimesheetService<DeSerializers<BinaryT,
BooleanT,
ByteT,
DecimalT,
DoubleT,
...
TimeT>>  
  {
  return new WorkforceTimesheetService(mergeDefaultDeSerializersWith(deSerializers))
  } 
class WorkforceTimesheetService<DeSerializersT extends DeSerializers = DefaultDeSerializers> {
